...
typedef struct
{
  __IO uint32_t FLASHCFG; 	/* Flash Accelerator Configuration register (FLASHCFG - address 0x400F C000)*/
	   uint32_t RESERVED0[31];
		
  __IO uint32_t PLL0CON;                /* Clocking and Power Control, 0x400F C080  */
  __IO uint32_t PLL0CFG;	  	/* PLL0 Configuration register (PLL0CFG - 0x400F C084) */
  ...
  __IO uint32_t CLKSRCSEL;	   		/* Clock Source Select register (CLKSRCSEL - 0x400F C10C) */
  ...
  __IO uint32_t SCS;                    /* System Controls and Status register (SCS - 0x400F C1A0) */
...
#define AHBRAM0_BASE          (0x2007C000UL)	// (0x20000000UL)
#define AHBRAM1_BASE          (0x20080000UL)	// (0x20004000UL)

#define GPIO_BASE			  (0x2009C000UL)	// added by Roger, 20090502	
...
// Added by Roger, 20090502
#define GPIO0_BASE            (GPIO_BASE  + 0x0000)
#define GPIO1_BASE            (GPIO_BASE  + 0x0020)
#define GPIO2_BASE            (GPIO_BASE  + 0x0040)
#define GPIO3_BASE            (GPIO_BASE  + 0x0060)
#define GPIO4_BASE            (GPIO_BASE  + 0x0080)
...
#define GPIOINT_BASE          (APB0_BASE + 0x28000)
...
#define GPIO0_BASE            (AHB_BASE  + 0x14000)
#define GPIO1_BASE            (AHB_BASE  + 0x14020)
#define GPIO2_BASE            (AHB_BASE  + 0x14040)
#define GPIO3_BASE            (AHB_BASE  + 0x14060)
#define GPIO4_BASE            (AHB_BASE  + 0x14080)
#endif
